...
- Initial release of `@urql/solid-start` - URQL integration built with SolidStart's native primitives.
  ...
  - **Uses `@solid-primitives/utils`** - Leverages standard Solid ecosystem utilities
    Submitted by [@davedbase](https://github.com/davedbase) (See [`120deb0`](https://github.com/urql-graphql/urql/commit/120deb0d1e5daafa7e811684dbe51f7553e46a5b))

### Patch Changes

- Updated dependencies (See [`120deb0`](https://github.com/urql-graphql/urql/commit/120deb0d1e5daafa7e811684dbe51f7553e46a5b))
  - @urql/solid@1.0.1
